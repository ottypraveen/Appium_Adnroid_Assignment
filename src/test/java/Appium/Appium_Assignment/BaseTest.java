...
public class BaseTest {
	...
	public void configureAppium() throws MalformedURLException, InterruptedException
	{
		...
		option.setApp("C:\\Users\\ottyp\\eclipse-workspace\\Appium_Assignment\\src\\test\\java\\Resources\\General-Store.apk");
	...
	public void tapEvent(Point centerOfElement)
	{
		PointerInput Finger1 =new PointerInput(PointerInput.Kind.TOUCH,"Finger1");
		  Sequence seq1=new Sequence(Finger1, 1).addAction(Finger1.createPointerMove(Duration.ZERO, PointerInput.Origin.viewport(), centerOfElement))
		  .addAction(Finger1.createPointerDown(PointerInput.MouseButton.LEFT.asArg()))
		  .addAction(new Pause(Finger1, Duration.ofMillis(200)))
		  .addAction(Finger1.createPointerMove(Duration.ofMillis(200), PointerInput.Origin.viewport(), centerOfElement))
